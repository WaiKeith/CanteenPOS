...
import my.edu.chiawaikeith.canteenpos.Adapters.TransactionAdapter;
...
public class TransactionDetails extends BaseActivity implements View.OnClickListener {
    ...
    private void startView() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        transactionAdapter = new TransactionAdapter(TransactionDetails.this, orderList, R.layout.view_orderline_row);
